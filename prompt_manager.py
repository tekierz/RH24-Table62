...
class PromptManager:
    ...
    def get_vision_user_prompt_1():
        ...
        return """Share your thoughts on this outfit like a supportive friend giving fashion advice! If they're wearing a black lanyard, give gentle suggestions for improvement while highlighting positives. If they're wearing a yellow, pink, or green lanyard, be extra enthusiastic and encouraging. Use phrases like 'I love how...', 'You're rocking...', and 'What a great choice!' Keep everything super positive and age-appropriate. NEVER mention the lanyard in your feedback. NEVER MAKE FUN OF THE PERSON'S PHYSICAL APPEARANCE, ONLY THEIR FASHION CHOICES.Keep response under 3 sentences."""
